    	...
    	if(Cont.getText().equals("make a decision")) {
 		  ...
 		  NewPricesTable.getColumns().clear();
 	    	...
 	    	CityName.setStyle( "-fx-alignment: CENTER;");
 	    	 ...
 	    	 CityName.setCellValueFactory(
 	                new PropertyValueFactory<NewPrices, String>("City"));
 	    	FixedCost.setStyle( "-fx-alignment: CENTER;");
 	    	FixedCost.setMinWidth(100);
 	    	FixedCost.setCellValueFactory(
 	                new PropertyValueFactory<NewPrices, String>("FixedCost"));
 	    	OneTimeCost.setStyle( "-fx-alignment: CENTER;");
 	    	OneTimeCost.setMinWidth(100);
 	    	OneTimeCost.setCellValueFactory(
	                new PropertyValueFactory<NewPrices, String>("OneTimeCost"));
 	    	buildData("NewPrices");
 	    	
 	    	FilteredList<NewPrices> flprice = new FilteredList<NewPrices>(data1, p -> true);//Pass the data to a filtered list
